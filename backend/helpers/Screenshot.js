...
class Screenshot {
    ...
    static monitor() {
        if(config.chatMonitor.nowPlaying && config.chatMonitor.nowPlaying.timeRemaining <= 103 && config.chatMonitor.nowPlaying.timeRemaining > 0 && !config.imageProcessing.screenshotStarted) {
